...
// Taken from pmndrs/drei github - https://github.com/pmndrs/drei/blob/master/src/materials/MeshRefractionMaterial.tsx
export class DiamondMaterial extends ShaderMaterial {
  constructor({
    envMap,
    color,
